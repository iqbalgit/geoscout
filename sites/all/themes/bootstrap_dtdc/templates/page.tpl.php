...
<header class="header-wrapper">
    	...
    	<div class="container">
            ...
            <div class="col-md-8 clear-both">
            	<div class="links">
                	<?php global $base_url; if ($logged_in): ?>
						<div class="left_links_top_first" id="welcome-user">	
							<?php global $user; $userdetails = user_load($user->uid); $name = $user->name; ?>			
							<p>Welcome <b><?php if(isset($name)){ echo $name; } ?></b></p>
							<a href='<?php echo $base_url; ?>/user/logout'><?php print "Logout";?></a>
						</div>
					<?php endif; ?>
					<?php if(!$logged_in): ?>
						<div class="left_links_top_first" id="welcome-user">					
							<a href="<?php echo $base_url; ?>/user/login"><?php print "Login";?></a>
						</div>
					<?php endif; ?>
